...
public class FrmUser extends javax.swing.JFrame {
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        ...
        if(tblTickets.getSelectedRowCount()==0){
          JOptionPane.showMessageDialog(this, "Sélectionner un ticket");  
        }
        else{ 
            ...
            fm.ModifierEtatTicket(idTicket, idEtat);

            fm=new FonctionsMetier();
            mdlTicket= new ModelTicket();
            mdlTicket.loadDatas(fm.GetAllTicketsByIdUser(leUser.getIdUser()));
