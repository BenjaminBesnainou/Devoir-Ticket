...
public class FrmAdmin extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for(Etat et:fm.GetAllEtats()){
         cboEtatsTickets.addItem(et.getNomEtat());   
        }
    ...
    private void btnInsererNouveauTicketMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnInsererNouveauTicketMouseClicked
     if(tblUsers.getSelectedRowCount()==0){
         JOptionPane.showMessageDialog(this, "Sélectionner un user");
     }   
     else if(txtNomTicket.getText().compareTo("")==0){
         JOptionPane.showMessageDialog(this, "Saisir un nom de ticket");
     }
    
    else{
        fm=new FonctionsMetier();
        int idEtat= fm.GetIdEtat(cboEtatsTickets.getSelectedItem().toString());
        int idTicket= Integer.parseInt(txtNumTicket.getText());
        String nomTicket=txtNomTicket.getText();
        String date="2020-12-15";
        int idUser=Integer.parseInt(tblUsers.getValueAt(tblUsers.getSelectedRow(), 0).toString());
        fm.InsererTicket(idTicket, nomTicket, date, idUser, idEtat);
